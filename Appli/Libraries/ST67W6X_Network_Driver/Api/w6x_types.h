...
#include "w61_driver_config.h" /* Needed for W61_WIFI_MAX_DETECTED_AP */
...
typedef enum
{
  ...
  W6X_STATUS_NOT_SUPPORTED  = 3,  /*!< Operation not supported */
} W6X_Status_t;
...
#define W6X_WIFI_MAX_CONNECTED_STATIONS 10                        /*!< Maximum number of connected stations */

#define W6X_WIFI_SIZEOF_IPV4_BYTES      4                         /*!< Size of an IPv4 address in bytes */

#define W6X_WIFI_MAX_APS                W61_WIFI_MAX_DETECTED_AP  /*!< max number of AP detectable during the scan */
...
typedef enum
{
  W6X_SECURITY_OPEN = 0x00,             /*!< Wi-Fi is open */
  W6X_SECURITY_WEP = 0x01,              /*!< Wired Equivalent Privacy option for Wi-Fi security. */
  W6X_SECURITY_WPA_PSK = 0x02,          /*!< Wi-Fi Protected Access */
  W6X_SECURITY_WPA2_PSK = 0x03,         /*!< Wi-Fi Protected Access 2 */
  W6X_SECURITY_WPA_WPA2_PSK = 0x04,     /*!< Wi-Fi Protected Access with both modes */
  W6X_SECURITY_WPA_ENT = 0x05,          /*!< Wi-Fi Protected Access */
  W6X_SECURITY_WPA3_SAE = 0x06,         /*!< Wi-Fi Protected Access 2 */
  W6X_SECURITY_WPA2_WPA3_SAE = 0x07,    /*!< Wi-Fi Protected Access with both modes */
  W6X_SECURITY_UNKNOWN = 0x08,          /*!< Other modes */
} W6X_SecurityType_e;
...
typedef enum
{
  W6X_WIFI_MODE_802_11B       = 0x01,               /*!< 802.11 b */
  W6X_WIFI_MODE_802_11A       = 0x02,               /*!< 802.11 a */
  W6X_WIFI_MODE_802_11G       = 0x04,               /*!< 802.11 g */
  W6X_WIFI_MODE_802_11N_2_4   = 0x08,               /*!< 802.11n at 2.4GHz */
  W6X_WIFI_MODE_802_11N_5     = 0x10,               /*!< 802.11n at 5GHz */
  W6X_WIFI_MODE_802_11AC_5    = 0x20,               /*!< 802.11ac at 5GHz */
  W6X_WIFI_MODE_802_11AC_2_4  = 0x40,               /*!< 802.11ac at 2.4GHz */
  W6X_WIFI_MODE_802_11AX_2_4  = 0x80,               /*!< 802.11ax at 2.4GHz */
} W6X_WiFiType_e;
...
/**
  * @brief  Wi-Fi Access Point status enumeration
  */
typedef enum
{
  W6X_WIFI_STATE_AP_RESET                   = 0,    /*!< Access Point reset */
  W6X_WIFI_STATE_AP_RUNNING                 = 1,    /*!< Access Point running */
  W6X_WIFI_STATE_AP_OFF                     = 2,    /*!< Access Point off */
} W6X_ApStateType_e;
...
typedef enum
{
  ...
  W6X_WIFI_DHCP_AP_ENABLED             = 2,  /*!< DHCP server enabled for Access Point */
  W6X_WIFI_DHCP_STA_AP_ENABLED         = 3,  /*!< DHCP client enabled for station and DHCP server for Access Point */
} W6X_DhcpType_e;
...
/* ===================================================================== */
/* W6X_event_id_t */
/** event_args parameter to be casted to W6X_CbParamNetData_t */
...
typedef enum
{
  W6X_TCP_PROTOCOL = 0,         /*!< TCP protocol */
  W6X_UDP_PROTOCOL = 1,         /*!< UDP protocol */
  W6X_SSL_PROTOCOL = 2          /*!< SSL protocol */
} W6X_Protocol_t;
...
typedef enum
{
  TLS_CREDENTIAL_NONE = 0,                      /*!< No Credential */
  TLS_CREDENTIAL_CA_CERTIFICATE = 1,            /*!< CA Certificate, to authenticate peer */
  TLS_CREDENTIAL_SERVER_CERTIFICATE = 2,        /*!< Certificate for to be authenticated by peer, to be used with private key */
  TLS_CREDENTIAL_PRIVATE_KEY = 3,               /*!< Private key to be used with Certificate to be authenticated by peer */
  TLS_CREDENTIAL_PSK = 4,                       /*!< Pre shared key for PSK authentication */
  TLS_CREDENTIAL_PSK_ID = 5                     /*!< Identity to be used with PSK for PSK authentication */
} W6X_Tls_Credential_t;
...
/* ===================================================================== */
/* W6X_event_id_t */
/* #define W6X_BLE_EVT_SCAN_ID                            120 */
#define W6X_BLE_EVT_CONNECTED_ID                       121  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
#define W6X_BLE_EVT_DISCONNECTED_ID                    122  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
#define W6X_BLE_EVT_CONNECTION_PARAM_ID                123  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
#define W6X_BLE_EVT_READ_ID                            124  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
#define W6X_BLE_EVT_WRITE_ID                           125  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
#define W6X_BLE_EVT_SERVICE_FOUND_ID                   126  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
#define W6X_BLE_EVT_CHAR_FOUND_ID                      127  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
#define W6X_BLE_EVT_INDICATION_STATUS_ENABLED_ID       128  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
#define W6X_BLE_EVT_INDICATION_STATUS_DISABLED_ID      129  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
#define W6X_BLE_EVT_NOTIFICATION_STATUS_ENABLED_ID     130  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
#define W6X_BLE_EVT_NOTIFICATION_STATUS_DISABLED_ID    131  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
#define W6X_BLE_EVT_NOTIFICATION_DATA_ID               132  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
#define W6X_BLE_EVT_MTU_SIZE_ID                        133  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
#define W6X_BLE_EVT_PAIRING_FAILED_ID                  134  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
#define W6X_BLE_EVT_PAIRING_COMPLETED_ID               135  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
#define W6X_BLE_EVT_PAIRING_CONFIRM_ID                 136  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
#define W6X_BLE_EVT_PASSKEY_ENTRY_ID                   137  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
#define W6X_BLE_EVT_PASSKEY_DISPLAY_ID                 138  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
#define W6X_BLE_EVT_PASSKEY_CONFIRM_ID                 139  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
#define W6X_BLE_EVT_BAS_LEVEL_ID                       140  /*!< event_args parameter to be casted to W6X_CbParamBleData_t */
...
/** max number of AP detectable during the scan */
#define W6X_BLE_MAX_PERIPHERAL                         W61_BLE_MAX_DETECTED_PERIPHERAL

/**
  * @brief  BLE characteristic property index enumeration
  */
enum w6x_ble_char_property
{
...
typedef enum
{
  BLE_SEC_IO_DISPLAY_ONLY = 0,
  BLE_SEC_IO_DISPLAY_YESNO = 1,
  BLE_SEC_IO_KEYBOARD_ONLY = 2,
  BLE_SEC_IO_NO_INPUT_OUTPUT = 3,
  BLE_SEC_IO_KEYBOARD_DISPLAY = 4
} W6X_Ble_SecurityParameter_t;
...
#define REQ_TYPE_HEAD  1                                  /*!< HTTP HEAD request */
#define REQ_TYPE_GET   2                                  /*!< HTTP GET request */
#define REQ_TYPE_POST  3                                  /*!< HTTP POST request */
#define REQ_TYPE_PUT   4                                  /*!< HTTP PUT request */

/** Maximum size of accepted HTTP response buffer */
#define HTTP_HEAD_MAX_RESP_BUFFER_SIZE           (2048U)
...
/**
  ...
  *         - W6X_CbParamWiFiData_t for [W6X_WIFI_EVT_CONNECTED_ID, W6X_WIFI_EVT_DISCONNECTED_ID,
  *                                      W6X_WIFI_EVT_GOT_IP_ID]
  *         - .. for [W6X_WIFI_EVT_STA_CONNECTED_ID, W6X_WIFI_EVT_STA_DISCONNECTED_ID, W6X_WIFI_EVT_DIST_STA_IP_ID]
  */
typedef void (*App_wifi_Cb)(W6X_event_id_t event_id, void *event_args);
...
typedef struct
{
  ...
  W6X_SecurityType_e Security;                      /*!< Security of Wi-Fi spot */
  int16_t RSSI;                                     /*!< Signal strength of Wi-Fi spot */
  uint8_t MAC[6];                                   /*!< MAC address of spot */
  uint8_t Channel;                                  /*!< Wi-Fi channel */
  W6X_CipherType_e Group_cipher;                    /*!< Group cipher value */
  W6X_WiFiType_e WiFi_version;                      /*!< Wi-Fi revision supported */
...
typedef struct
{
  ...
  W6X_Ap_t AP[W6X_WIFI_MAX_APS];                    /*!< Array of AP Beacon information */
} W6X_Scan_Result_t;

/**
  * @brief  Wi-Fi Scan result callback
  */
typedef void(* scan_result_cb_t)(int32_t status, W6X_Scan_Result_t *entry);
...
typedef struct
{
  ...
  W6X_scan_type_e Scan_type;                        /*!< Scan type (0: Active, 1: Passive) */
...
/**
  * @brief  Connection status structure
  */
typedef struct
{
  /** Service Set Identifier value. Wi-Fi Access Point name */
...
typedef struct
{
  uint8_t SSID[W6X_WIFI_MAX_SSID_SIZE + 1];         /*!< Service Set Identifier value. Wi-Fi Access Point name */
  uint8_t Password[W6X_WIFI_MAX_PASSWORD_SIZE + 1]; /*!< Password of Wi-Fi Access Point */
  W6X_SecurityType_e Security;                      /*!< Security encryption of the Wi-Fi Access Point */
...
typedef struct
{
  ...
  W6X_Connected_Sta_Info_t STA[W6X_WIFI_MAX_CONNECTED_STATIONS];   /*!< Array of connected stations */
} W6X_Connected_Sta_t;
...
/**
  ...
  *         - W6X_CbParamNetData_t for all existing events
  */
typedef void (*App_net_Cb)(W6X_event_id_t event_id, void *event_args);
...
/**
  ...
  *         - W6X_CbParamMqttData_t for [W6X_MQTT_EVT_SUBSCRIPTION_RECEIVED_ID]
  */
typedef void (*App_mqtt_Cb)(W6X_event_id_t event_id, void *event_args);
...
/**
  ...
  *         - W6X_CbParamBleData_t for all existing events
  */
typedef void (*App_ble_Cb)(W6X_event_id_t event_id, void *event_args);
...
typedef struct
{
  ...
  char ServiceUUID[W6X_BLE_MAX_UUID_SIZE];  /*!< Service UUID */
...
typedef struct
{
  W6X_Ble_SecurityParameter_t sec_param;        /*!< Security parameter */
...
typedef struct
{
  W6X_Ble_ScanType_t scan_type;                    /*!< Scan type (1: Active, 0: Passive) */
  W6X_Ble_AddrType_t own_addr_type;                /*!< BLE Address type */
  W6X_Ble_FilterPolicy_t filter_policy;            /*!< BLE Scan filter policy */
...
typedef struct
{
  ...
  W6X_Ble_Scanned_Device_t Detected_Peripheral[W6X_BLE_MAX_PERIPHERAL];   /*!< Array of BLE peripherals information. */
} W6X_Ble_Scan_Result_t;

/**
  * @brief  BLE Scan result callback
  */
typedef void(* ble_scan_result_cb_t)(W6X_Ble_Scan_Result_t *entry);
...
typedef struct
{
  W6X_Ble_AddrType_t remote_addr_type;              /*!< BLE Address type */
  uint8_t BDAddr[W6X_BLE_BD_ADDR_SIZE];             /*!< BD address of BLE Device */
...
typedef struct
{
  App_wifi_Cb     APP_wifi_cb;                            /*!< Callback for Wi-Fi events */
  App_net_Cb      APP_net_cb;                             /*!< Callback for Network events */
  App_mqtt_Cb     APP_mqtt_cb;                            /*!< Callback for MQTT events */
  App_ble_Cb      APP_ble_cb;                             /*!< Callback for BLE events */
} W6X_App_Cb_t;
...
typedef struct
{
  int32_t proxy_addr;         /*!< Proxy address */
  uint16_t proxy_port;        /*!< Proxy port */
  uint8_t use_proxy;          /*!< Use proxy (Not supported at the moment)*/
  uint8_t req_type;           /*!< HTTP type of request */
...
/**
  * @brief  Define HTTP request structure
  */
typedef enum
{
  W6X_HTTP_MODE_ACTIVE = 0,   /*!< HTTP Get Active mode */
  W6X_HTTP_MODE_PASSIVE = 1   /*!< HTTP Get Passive mode */
} W6X_http_mode_e;

/**
  * @brief Define HTTP IPv4 address structure
  */
typedef uint32_t ip4_addr_t;

/**
  * @brief Define HTTP IPv6 address structure
  */
...
/**
  * @brief Define HTTP IP address structure
  */
...
/* Forward declaration needed for callbacks */
struct httpc_connection;

/**
  * @brief Define HTTP connection state
  */
typedef int32_t httpc_state_t;

/**
  * @brief Define HTTP result callback
  ...
  */
typedef void (*httpc_result_fn)(void *arg, HttpStatusCode httpc_result, uint32_t rx_content_len,
                                uint32_t srv_res, int32_t err);

/**
  * @brief Define HTTP headers done callback
  ...
  */
typedef int32_t (*httpc_headers_done_fn)(httpc_state_t *connection, void *arg, uint8_t *hdr, uint16_t hdr_len,
                                         uint32_t content_len);

/**
  * @brief Define HTTP data callback
  * @param arg: Callback argument
  * @param p: Pointer to data
  * @param err: Error code
  */
typedef int32_t (*httpc_data_fn)(void *arg, uint8_t *p, int32_t err);

/**
  * @brief  Define HTTP connection structure
  */
struct httpc_connection
{
  ...
  httpc_headers_done_fn headers_done_fn;    /*!< Headers done callback */
  httpc_result_fn result_fn;                /*!< Result callback */
  void *callback_arg;                       /*!< Callback argument */
  httpc_data_fn recv_fn;                    /*!< Receive callback */
