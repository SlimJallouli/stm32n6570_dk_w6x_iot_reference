...
/* Exported variables --------------------------------------------------------*/
/* Exported macros -----------------------------------------------------------*/
/** @defgroup ST67W6X_Utilities_Common_Macros ST67W6X Utility Commons Macros
...
#define NIP2STR_FMT "%u.%u.%u.%u"
#endif /* NIP2STR */

/** @} */

/* Exported functions ------------------------------------------------------- */
/** @defgroup ST67W6X_Utilities_Common_Functions ST67W6X Utility Commons Functions
  * @ingroup  ST67W6X_Utilities_Common
  * @{
  */
...
/**
  ...
  *         of an Internet address and convert to a uint32_t host byte order.
  *         Returns 1 if the address is valid, 0 if not.
  *         This replaces inet_addr, the return value from which
  *         cannot distinguish between failure and a local broadcast address.
  *         In this version, the addr result is not in Network Byte order.
  * @param  cp: IP address in ascii representation (e.g. "127.0.0.1")
  * @param  addr: pointer to which to save the ip address, if the pointer equals NULL then no operation is done on it.
