...
/**
  ...
  * @param  APP_wifi_cb: Callback for Wi-Fi events
  * @param  APP_net_cb: Callback for Network events
  * @param  APP_mqtt_cb: Callback for MQTT events
  * @param  APP_ble_cb: Callback for BLE events
  * @return Operation status.
  */
...
/**
  * @brief  Configure Power Save mode
  * @param  enable: power save mode to set (0: disable, 1: auto)
  * @return Operation Status.
  */
...
/**
  ...
  * @param  enable: power save mode  (0: disable, 1: enable)
  * @return Operation Status.
  */
...
/**
  ...
  */
void W6X_WiFi_PrintScan(W6X_Scan_Result_t *Results);
...
#if 0
/**
  * @brief  Enable / Disable the auto connect functionality
  * @param  OnOff : define the module state (enable = 1 / disable = 0) auto connect
  * @return Operation status
  */
...
/**
  * @brief  Get the Access Point configuration
  * @param  ap_config: Access Point configuration
  * @return Operation status
  */
...
/**
  * @brief  Print the Wi-Fi security type
...
/**
  * @brief  Print the Wi-Fi error reason
...
/**
  * @brief  Get SNTP Synchronisation interval
...
/**
  * @brief  Set SNTP Synchronisation interval
...
/**
  * @brief  Start the NCP OTA update process over WiFi
  * @param  http_server_addr: Address of the http server containing the firmware binary. Required to be an IPv4 address
  * @param  http_server_port: Port of the http server
  * @param  uri: URI of the firmware binary
  * @return W6X_Status_t Operation status
  */
...
/* ===================================================================== */
/**
  * @brief  Init the HTTP module
  * @param  HTTP_mode: HTTP mode to use
  * @return Operation status
  */
W6X_Status_t W6X_HTTP_Init(W6X_http_mode_e HTTP_mode);

/**
  * @brief  Init the HTTP client by connecting to a TCP socket where the HTTP server is located
  *         This is the IP version (no DNS supported) with IPv4 support
  * @param  sock: Number of the sock that is used for the TCP socket client creation
  * @param  http_server_addr: HTTP server address to connect TCP socket to
  * @param  http_server_port: HTTP server port to connect TCP socket to
  * @return int32_t Return W6X_STATUS_OK if success, W6X_STATUS_ERROR otherwise
  */
W6X_Status_t W6X_HTTP_Client_Init(int32_t *sock, const char *http_server_addr, uint16_t http_server_port);

/**
  * @brief  De init the http client,
  *         Currently this translates by closing the TCP socket
  * @param  sock: Number of the socket to close
  * @return int32_t Return W6X_STATUS_OK if success, W6X_STATUS_ERROR otherwise
  */
...
/**
  * @brief  Get http data size from a given URL
...
/**
  * @brief  Send http client request
  * @param  Option: HTTP option (GET, POST, PUT)
  * @param  ContentType: Content type (JSON, XML, TEXT)
  * @param  Url: URL to get data from
...
/**
  * @brief  Get http data from a given URL
  * @param  Url: URL to get data from
...
/**
  * @brief  Request a GET http data from a given URL and return the size available
  * @param  Url: URL to get data from
  * @param  Size: Size available of the http data
  * @param  Timeout: Timeout in ms
  * @return Operation Status.
  */
...
/**
  * @brief  Pull http data chunk if a passive GET request has been done before
...
/**
  * @brief  Put http data to a given URL
...
/**
  * @brief  Post http data to a given URL
...
/**
  ...
  * @param  service_index: index of the service to create
  * @param  ServicesTable: pointer the services and characteristics table (can be NULL if not required)
  * @return Operation status.
  */
...
/**
  ...
  * @param  service_uuid: UUID of the characteristic to create
